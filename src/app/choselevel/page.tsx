...
<div className='flex flex-col gap-4 '>
    ...
    <p className='text-[18px] text-white font-normal'>Create your account to explore personalized mortgage offers, apply with ease, and stay connected with top lenders.</p>
        ...
        <div className='flex flex-col gap-2 w-full p-10 items-center '>
            <span className='flex flex-col  items-center'>

            <h2 className='text-[34px] font-semibold text-[#111827]'>Choose Your Role to 
</h2>
...
<div className=' grid grid-cols-2 xs:grid-cols-1 gap-6'>
    ...
    <span className=' text-black px-4 font-medium text-[20px] py-2 rounded-lg cursor-pointer'>Borrower</span>
    <span className=' text-[#4D5259] px-4 py-2 rounded-lg cursor-pointer'>Find the perfect loan for your dream home</span>
    ...
    >
      <button className="text-[#013E8C] font-semibold w-full cursor-pointer rounded-full">
        Get Started
      </button>
    </Link>
  </span>
...
<span className='flex flex-col rounded-[25px] bg-[#DBEAFE] hover:bg-[#F0FDFA] items-center justify-center p-4'>
    ...
    <span className=' text-black px-4 font-medium text-[20px] py-2 rounded-lg cursor-pointer'>Lender</span>
    <span className=' text-[#4D5259] px-4 py-2 rounded-lg cursor-pointer'>Connect with qualified borrowers instantly</span>
   <span className="text-black px-4 py-2 rounded-lg w-full cursor-pointer">
    <Link
      href={{
        pathname: "/login",
...
<span className='flex flex-col rounded-[25px] bg-[#DBEAFE] hover:bg-[#F0FDFA] items-center justify-center p-4'>
    ...
    <span className=' text-black px-4 font-medium text-[20px] py-2 rounded-lg cursor-pointer'>Lawyer</span>
    <span className=' text-[#4D5259] px-4 py-2 rounded-lg cursor-pointer'>Provide legal support for real estate transactions</span>
    <span className="text-black px-4 py-2 rounded-lg w-full cursor-pointer">
    <Link
      href={{
        pathname: "/login",
    ...
    <span className=' text-black px-4 font-medium text-[20px] py-2 rounded-lg cursor-pointer'>Key Partner</span>
    <span className=' text-[#4D5259] px-4 py-2 rounded-lg cursor-pointer'>Earn rewards through our referral program</span>
   <span className="text-black px-4 py-2 rounded-lg w-full cursor-pointer">
    <Link
      href={{
        pathname: "/login",
